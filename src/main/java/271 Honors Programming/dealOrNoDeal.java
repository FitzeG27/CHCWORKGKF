   ...
   //Opened Cases Array
      private ArrayList<JButton> opened = new ArrayList();
 ...
 //***************************************************************************
       ...
       public void buttonClicked (JButton buttonObj)
      {
         ...
         if(buttonObj==Deal)
         {
            ...
            if(yourcase<bankOffer)
               Directions.setText("You made a good deal!!  Your case contained: $" + yourcase);
...
//***************************************************************************
      ...
      {
         if(yourcase==Case[x])
         {Directions.setText("You cant pick your own case.");
            return;
         }
...
//***************************************************************************    
      ...
      {
         if(caseButtons[x].getText().substring(0,1).equals("$"))
         {
            return false;
         }
         else 
...
//***************************************************************************
       ...
       private void bankOffer()
      {
         ...
         Directions.setText("The Banker Has offered: $"+(double)(sum/size));
         doYouAccept();
